...
- **Standard:** built to the [Ka0s WoW Addon Standard](https://github.com/tusharsaxena/WowAddonStandards) (`standards/01_STANDARD.md` in that repo). The most recent compliance audit + remediation is frozen under [audit/2026-07-12/](./audit/2026-07-12/) (standard v1.0.0). Re-audit anytime with `/wow-addon:standards-audit`. **Accepted, deliberate deviations are recorded as bullets in this file** (see the §1.1 and §2.1 exceptions below) — that list is the source of truth for what intentionally diverges.
